...
" Variables {{{1
let s:lynxPath = 'c:\\cygwin\\bin\\'
let s:lynxExe = s:lynxPath . 'lynx.exe'
let s:lynxCfg = '-cfg=c:\\cygwin\\etc\\lynx.cfg'
let s:lynxLss = '-lss=c:\\cygwin\\etc\\lynx.lss'
let s:lynxCmd = s:lynxExe . ' ' . s:lynxCfg . ' ' . s:lynxLss
echo s:lynxCmd
let g:WbLynxDumpPath = 'c:\\cygwin\\var\\lynx\\dump\\'
let s:lynxToolsPath = 'c:\\cygwin\\var\\lynx\\tools\\'
